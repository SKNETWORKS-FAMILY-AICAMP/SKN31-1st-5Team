...
---
## 🗂️ 프로젝트 개요
- 본 프로젝트는 렌터카 대여의 '잠재적 추가고객 확충'을 위해 공공데이터 서버의 API 자료중, 「자동차 등록현황」과 「자동차 사고건수 다발지역」에 대한 자료를 수집하고 Streamlit 기반의 데이터 시각화를 구현하였습니다.

<!-- ★ 잠재적 렌터카 고객이 많은지역 : 
- 사고다발지역 (공공데이터)
- 아직 차가 없는 20～30대 젊은층이 많은지역 (공공데이터) -->

<br>

---
## 💡 프로젝트 목표
- 공공데이터를 활용해 잠재적 고객이 많은 지역과 연령대를 분석한다.
- open API를 통한 데이터 수집
- MySQL DB  연동
- Streamlit을 이용한 시각화
...
본 프로젝트에서는 '사고 발생건수 데이터'와 '지역별 자동차 등록자료' 등을 확보하여, 잠재적 렌터카 고객이 많은 지역을 분석하고 예측한다.
